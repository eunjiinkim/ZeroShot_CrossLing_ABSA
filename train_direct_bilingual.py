...
from evaluator_bieos import get_score_mask_feeling as get_score
import random
...
if __name__ == '__main__':
    ...
    seed_everything(42)
    model = PairGenerator()
    save_model_path = 'model_{}/{}_{}_lr={}_bs={}_sep={}_frz={}_{}_{}_mask_feeling_new'.format(args.lang, args.domain, args.lang, args.lr, args.batch_size, args.separator, args.freeze, args.time, args.num)
